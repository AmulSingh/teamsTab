...
export interface IOnemoretabTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IOnemoretabTabRemoveProps {

}

/**
 * Implementation of onemoretab Tab remove page
 */
export class OnemoretabTabRemove  extends TeamsBaseComponent<IOnemoretabTabRemoveProps, IOnemoretabTabRemoveState> {
